...
lines = [
    ...
    play.new_line(color='blue', x=-35, y=-35, length=185,
        angle=90, thickness=5, x1=None, y1=None),
    play.new_line(color='blue', x=-90, y=-225, length=315,
        angle=90, thickness=5, x1=None, y1=None),
    play.new_line(color='blue', x=-95, y=150, length=65,
        angle=90, thickness=5, x1=None, y1=None),
    play.new_line(color='blue', x=-215, y=-280, length=65,
        angle=90, thickness=5, x1=None, y1=None),
    play.new_line(color='blue', x=-215, y=-165, length=190,
        angle=90, thickness=5, x1=None, y1=None),
]
