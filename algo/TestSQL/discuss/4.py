""" Передаём информацию в шаблон: теги игнорируются!
Оформление указывается в шаблоне, данные не должны содержать информацию об оформлении.
Обратить внимание: css все это время не работает!
"""
