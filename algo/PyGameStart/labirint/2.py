...
#Персонажи игры:
player = Player('hero.png', player_x=5, player_y=win_height - 80,
                            player_speed=4, hero_size=hero_size)
monster = Enemy('cyborg.png',  player_x=win_width - 80, player_y=280,
                            player_speed=2 , hero_size=hero_size)
final = GameSprite('treasure.png', player_x=win_width - 120, player_y=win_height - 80,
                            player_speed=0 , hero_size=hero_size)
